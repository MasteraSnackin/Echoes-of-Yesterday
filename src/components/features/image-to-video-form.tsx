...
import { imageToVideoAction } from '@/app/actions';
...
export function ImageToVideoForm() {
  ...
  const handleGenerate = async () => {
    ...
    const result = await imageToVideoAction({
      imageUrl,
      prompt,
      apiKey,
    });
    ...
    <div className="grid gap-8 md:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate a short video from an image and an optional prompt using the Fal.ai Kling API. Videos can take a few minutes to generate.
          </CardDescription>
        </CardHeader>
