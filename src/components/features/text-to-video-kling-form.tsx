...
import { klingVideoAction } from '@/app/actions';
...
export function TextToVideoKlingForm() {
  ...
  const handleGenerate = async () => {
    ...
    const result = await klingVideoAction({
      prompt,
      apiKey,
    });
  ...
  return (
    <div className="grid gap-8 md:grid-cols-2">
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-2xl">Text-to-Video with Kling</CardTitle>
          <CardDescription>
            Generate a short video from a text prompt using the Fal.ai Kling API. Videos can take a few minutes to generate.
          </CardDescription>
        </CardHeader>
